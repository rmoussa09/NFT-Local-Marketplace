...
public class userDAO 
{
    ...
    protected void connect_func() throws SQLException {
        ...
        if (connect == null || connect.isClosed()) {
            ...
            connect = (Connection) DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/testdb?allowPublicKeyRetrieval=true&useSSL=false&user=raja&password=obito");
    ...
    public List<user> stats() throws SQLException {
    	List<user> users = new ArrayList<user>(); 
     	String sql = "SELECT * FROM Trans";
        System.out.println(sql);
     	 try {
